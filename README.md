...
Проект распространяется под лицензией **MIT**. Полный текст лицензии находится в файле [`LICENSE`](LICENSE) в корне репозитория.
Краткая суть лицензии MIT: вы можете свободно использовать, копировать, модифицировать, распространять и sublicensировать код при условии сохранения указания авторства и текста лицензии. Программное обеспечение предоставляется «как есть», без каких-либо гарантий.
Данная лицензия выбрана осознанно, чтобы максимально способствовать исследовательскому использованию, воспроизводимости и развитию проекта сообществом.
