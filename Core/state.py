...
class LeyaState:
    ...
    def __init__(self):
        ...
        # ====================================================================
        # 🆕 НЕПРЕРЫВНОЕ ПЕРЕЖИВАНИЕ (Continuity, Фаза 2)
        # ====================================================================
        self.subjective_time = 0.0          # Субъективное время (секунды)
        self.time_perception_rate = 1.0     # Скорость восприятия времени
        self.background_sensations = {}     # Фоновые ощущения
        self.emotional_baseline = {}        # Базовое настроение
