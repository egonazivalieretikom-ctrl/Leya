...
import logging
from typing import TYPE_CHECKING, Any, Protocol, runtime_checkable, Optional, runtime_checkable

from .config import HomeostasisConfig
from .global_workspace import WorkspaceProposal

if TYPE_CHECKING:
    # Импорт только для проверки типов (Protocols + experimental), избегает циклического импорта в runtime
