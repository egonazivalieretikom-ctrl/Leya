...
class LeyaConfig:
    ...
    def from_env(cls) -> "LeyaConfig":
        ...
        try:
            ...
            thinker = ThinkerConfig(
                ...
                fallback_enabled=os.environ.get("THINKER_FALLBACK_ENABLED", "true").lower()
                == "true",
            ...
            reflection = ReflectionConfig(
                ...
                existential_inquiry_enabled=os.environ.get("REFLECTION_EXISTENTIAL", "true").lower()
                == "true",
                behavioral_analysis_enabled=os.environ.get("REFLECTION_BEHAVIORAL", "true").lower()
                == "true",
                insight_generation_enabled=os.environ.get("REFLECTION_INSIGHTS", "true").lower()
                == "true",
            )
            ...
            constitutional = ConstitutionalConfig(
                ...
                enable_response_verification=os.environ.get(
                    "CONSTITUTIONAL_VERIFY_RESPONSE", "true"
                ).lower()
                == "true",
                enable_tool_verification=os.environ.get(
                    "CONSTITUTIONAL_VERIFY_TOOLS", "true"
                ).lower()
                == "true",
    ...
    def print_summary(self):
        ...
        logger.info(
            f"Thinker: temp={self.thinker.temperature}, max_tokens={self.thinker.max_tokens}, context_limit={self.thinker.max_context_tokens}"
        )
