...
class DecisionEngine:
    ...
    def make_decision(self, stimulus: str, drive_state: Dict[DriveType, float]) -> Decision:
        ...
        return Decision(
            use_tool=False,
            reasoning="Нет критических потребностей для использования инструментов"
        )
    ...
    def _extract_topic(self, stimulus: str) -> list:
        ...
        cleaned = stimulus
        for pattern in [r'изучи\s+', r'узнай\s+', r'расскажи о\s+',
                       r'тему\s+', r'на тему\s+']:
    ...
    def _is_technical_topic(self, topic: str) -> bool:
        ...
        tech_keywords = ['api', 'code', 'python', 'javascript', 'library',
