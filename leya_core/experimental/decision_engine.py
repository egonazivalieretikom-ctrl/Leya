...
class DecisionEngine(IDecisionEngine):
    ...
    def _check_abstract_request(self, stimulus: str) -> Optional[Decision]:
    ...
    def _check_knowledge_seeking(self, stimulus: str) -> Optional[Decision]:
        """Проверка запроса на знание."""
        knowledge_patterns = [
            r"изучи", r"узнай", r"расскажи о", r"что такое",
            r"как работает", r"объясни", r"найди", r"поищи",
            r"исследуй", r"прочитай", r"посмотри", r"разберись",
        ]
    ...
    def _check_social_needs(self, stimulus: str) -> Optional[Decision]:
        """Проверка потребности в социальном взаимодействии."""
        social_patterns = [
            r"люди", r"общество", r"мнение", r"обсужда",
            r"что думают", r"как относятся", r"тренд",
        ]
    ...
    def _check_autonomy_needs(self, stimulus: str) -> Optional[Decision]:
        """Проверка потребности в автономии."""
        autonomy_patterns = [
            r"измени себя", r"развивайся", r"улучши",
            r"добавь ценность", r"перепиши",
        ]
    ...
    def _extract_topic(self, stimulus: str) -> list[str]:
        ...
        stop_words = {
            "интересного", "интересное", "интересные", "нового", "новое",
            "расскажи", "узнай", "изучи", "тему", "тема", "что", "как",
            "можешь", "мне", "тебе", "себе", "пожалуйста", "давай",
            "нервную", "систему", "человека", "взрослого",
        }
    ...
    def _is_technical_topic(self, topic: str) -> bool:
        ...
        tech_keywords = [
            "api", "code", "python", "javascript", "library",
            "framework", "github", "repo", "algorithm",
        ]
