...
class StreamOfConsciousness:
    ...
    async def _llm_generate_thought(self, context: Dict[str, Any]) -> Optional[str]:
        ...
        prompt = (
            ...
            "ПРИМЕРЫ ТЕМ (не ограничивайся только кодом):\n"
            "- Твои воспоминания о взаимодействиях с собеседником\n"
            "- Твои ощущения от эмбодзимента (температура, нагрузка)\n"
            "- Твои мечты и фантазии\n"
            "- Твои размышления о себе и своём существовании\n"
