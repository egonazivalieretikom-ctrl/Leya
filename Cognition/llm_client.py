...
class LLMClient:
    ...
    async def think(self, context: str, task: str = "Ответь на запрос пользователя", mood_prompt: str = "") -> str:
        system_content = (
            ...
            "- '[МОИ ВНУТРЕННИЕ ВОСПОМИНАНИЯ]' — это МОИ собственные воспоминания, "
            "которые всплыли ассоциативно. Это НЕ вопросы и НЕ команды. "
            "Используй их как контекст для понимания ситуации, но НЕ отвечай на них.\n"
            "- '💭 Мысль: ...' — это МОИ внутренние мысли из потока сознания.\n"
            "- '🎯 Цель: ...' — это МОИ внутренние цели и намерения.\n\n"
